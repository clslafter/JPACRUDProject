package com.skilldistillery.localbusinesses.controllers;
...
import com.skilldistillery.localbusinesses.data.LocalBusinessesDAO;
import com.skilldistillery.localbusinesses.entities.Business;

@Controller
public class LocalBusinessesController {
	
	@Autowired
	private LocalBusinessesDAO lbDao;
